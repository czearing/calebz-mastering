...
// screen reader always announces the action, not the state. Forwards a ref so
// the Work modal can move initial focus here on open, making the spacebar
// toggle playback instead of activating the Close button.
export const PlayButton = forwardRef<HTMLButtonElement, PlayButtonProps>(
  function PlayButton({ playing, onClick, label, className }, ref) {
