...
// Generous vertical padding so sections read as distinct and the scroll feels
// calm, not cramped (Gestalt proximity: more space between than within).
const base =
  "w-full px-[var(--space-5)] py-[var(--space-10)] md:py-[var(--space-12)]";
const inner = "mx-auto w-full max-w-[var(--max-content)]";

export const Section = forwardRef<HTMLElement, SectionProps>(
  function Section({ heading, className, children, ...rest }, ref) {
    return (
