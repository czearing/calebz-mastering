...
import { readProgress } from "./useScrollSignal";
...
export function MotifSurface({ animate, onReady }: MotifSurfaceProps) {
  ...
  // on a demand frameloop without the idle loop running.
  useEffect(() => {
